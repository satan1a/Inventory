package com.satan1a.inventory;

import java.io.IOException;

import com.satan1a.inventory.control.Modern;
import com.satan1a.inventory.control.EditDialogController;
import com.satan1a.inventory.control.LoginDialogController;
import com.satan1a.inventory.control.MainLayoutController;
	...
	public void start(Stage primaryStage) {
		try {
			...
			this.primaryStage.getIcons().add(
	                new Image("file:src/com/satan1a/inventory/resources/images/cat.jpg"));
			showLoginDialog();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public boolean showEditDialog(Object o, Modern modern) {
		try {
			...
			dialogStage.getIcons().add(
					new Image("file:src/com/satan1a/inventory/resources/images/guest.jpg"));
